...
from final_DB.embeddingsV2 import embed_texts
...
def get_collections(client: chromadb.PersistentClient):
    ...
    col_kisa_report = client.get_or_create_collection(COLLECTION_KISA_REPORT)
    col_kisa_guide = client.get_or_create_collection(COLLECTION_KISA_GUIDE) ## 새로운 DB 
    return col_mitre, col_kisa_report,col_kisa_guide ## 반환 부분도 3개로 변경
