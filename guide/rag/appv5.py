...
from rag.utils import load_env

load_env()

CHROMA_DIR = os.getenv("CHROMA_DIR", "chroma_db")
COLLECTION_KISA = os.getenv("COLLECTION_KISA", "kisa_chunks")
...
debug = st.sidebar.checkbox("디버그(검색 결과 표시)", value=st.session_state.debug)
